...
<a name="item_01"><h2>Настроите политику маршрутизации для сетей офиса</h2></a>

## 1️. Настройка политики маршрутизации для офисных сетей (PBR)
...
### Пример логики (команды пока запоминать не нужно)
