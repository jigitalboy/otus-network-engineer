...
Ту важно учитывать, что для работы PBR этой конфигурации достаточно. И можем это верифицировать посредтвом такой комманды:
...
А дело в том, что на обоих маршрутизаторах R25 и R26 не настроены марштруты, укажывоющие на наши vlan 10 и 20 соответственно.

Мы настроим эти маршруты на обоих маршрутизаторах и посмотрим что мы получим.

На R25 мы укажем маршрутв в сторону **vlan 20 (10.128.10.0/24)**, с **next-hop** адресом **R28 e0/1 - 10.250.130.13**
...
![topology](image_ping02.png)

Теперь проверим как проходит траффик с наших хостов, находящихся в vlan 10 и vlan 20. 
